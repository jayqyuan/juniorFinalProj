...
import { editSingleCampusAsync } from '../reducers/singleCampusReducer';
...
function EditCampus(props) {
  ...
  return (
    ...
    <input placeholder='New Campus Image Url' type='url' value={form.imageURL} onChange={changeValue('imageURL')}/>
